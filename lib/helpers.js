...
function my_log(req_for_context, msg, details) {
    ...
    console.log(JSON.stringify({ msg, ip: req.ip, sessionID: req.sessionID, uid: req.session.uid, service: req.query.service, ...(details || {}) }))    
}
...
module.exports = { seconds_since, md5, get_hash, getAndDelete, pick, is_service_matching, decodeEntities, esupUserApps_canAccess, my_log, my_log_if_ticket }
