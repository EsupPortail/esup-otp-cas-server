    ...
    const methods = {
        ...
        esupnfc: {
            ...
            code_label: async (params, chosen) => {
                ...
                return `
                    <ol>
                        <li>Télécharger la dernière version de l'application Esup-Auth (pour <a href="https://play.google.com/store/apps/details?id=org.esupportail.esupAuth">Android</a> ou <a href="https://apps.apple.com/fr/app/esup-auth/id1563904941">IOS</a>) si ce n'est pas déjà fait.</li>
                        ...
                        <li>
                            ...
                            <ol style="list-style-type: circle;">
                                ...
                                <li>
                                    ...
                                    <div class="esupnfc_qrcode">${params.methods.esupnfc.server_infos.qrCode}</div>
                                </li>
                            </ol>
                            En cas de difficultés pour scanner le QR code, sélectionner "Saisie manuelle", et renseigner l'adresse <span class="inline-block">${params.apiUrl}</span>
                        </li>
                        <li>Cliquer sur <span class="inline-block">"${params.methods.esupnfc.server_infos.etablissement}"</span>.</li>
